# Generated by Django 4.0.1 on 2022-04-03 16:15
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('master', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='masters', to='crm.master')),
                ('service', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='services', to='crm.service')),
                ('working_hour', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='crm.workinghours')),
            ],
            options={
                'verbose_name': 'Запись',
